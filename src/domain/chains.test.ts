...
describe('buildBookChains', () => {
    ...
    const afterHours = {
      canceledOrders: [
        canceled({
          ...
          finalSeenTime: at('2026-08-13T21:05:02+03:00'),
        }),
      ],
      closedTrades: [
        trade({
          ...
          closeFinalSeenTime: at('2026-08-17T18:06:28+03:00'),
        }),
      ],
    };
  ...
  it('groups retry attempts by their non-null chainId alone', () => {
    const root = canceled({
      ...
      finalSeenTime: at('2026-08-23T21:31:00.000Z'),
    ...
    const [chain] = build({
      ...
      positions: [
        position({
          ...
          finalSeenTime: at('2026-08-24T21:31:00.000Z'),
        }),
      ],
      closedTrades: [
        trade({

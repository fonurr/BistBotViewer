...
function position(overrides: Partial<Position> = {}): Position {
  return {
    ...
    symbol: 'THYAO',
    orderTime: Date.parse('2026-08-24T10:00:00+03:00'),
    finalSeenTime: Date.parse('2026-08-24T10:01:00+03:00'),
    orderQuantity: 10,
    quantity: 10,
    averagePrice: 100,
    orderPrice: 100,
...
function trade(overrides: Partial<ClosedTrade> = {}): ClosedTrade {
  return {
    ...
    openFinalSeenTime: Date.parse('2026-08-20T10:01:00+03:00'),
    closeOrderTime: Date.parse('2026-08-21T16:00:00+03:00'),
    closeFinalSeenTime: Date.parse('2026-08-21T16:01:00+03:00'),
    quantity: 10,
